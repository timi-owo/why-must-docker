...
print_yellow "* installing 'zlib v${VERSION}' ···"

# don't edit those variables
DOWNLOAD_URL="https://www.zlib.net/zlib-${VERSION}.tar.gz"
DOWNLOAD_FILE="/tmp/zlib-${VERSION}.tar.gz"
SOURCE_DIR="/usr/local/src/zlib-${VERSION}"
